...
public class AHConDireccionamientoAbierto extends ArchivoHash
{
     ...
     * @param primo si se desea como tamaño inicial un primo
     */
	...
	openForRead();
	long pos = h(r);
	long actual = registerPos(); // se asigna el indice de registro donde estar�a ubicado el registro.
	do
	{
	    try
	    {
